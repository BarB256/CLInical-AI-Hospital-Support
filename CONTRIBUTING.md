...
1. All PRs have to be reviewed by at least one other team member
1. All changes MUST be made through Pull Requests. Direct commits to main are not allowed.
1. If you modify existing behavior, you MUST update relevant documentation.
1. Branch naming MUST follow the agreed format (e.g., feature/SCRUM-9/xyz, fix/SCRUM-9/xyz, chore/SCRUM-9/xyz).
1. PRs MUST stay focused. One feature/fix per PR (no mega PRs).
1. Every PR MUST clearly describe: What was changed, Why it was changed, Any side effects or breaking changes
